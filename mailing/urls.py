...
urlpatterns = [
    ...
    # Рассылки
    path('mailings/',  cache_page(60 * 15)(views.MailingListView.as_view()), name='mailing_list'),
    ...
    # Сообщения
    path('messages/',  cache_page(60 * 15)(views.MessageListView.as_view()), name='message_list'),
    path('messages/create/', views.MessageCreateView.as_view(), name='message_create'),
    path('messages/<int:pk>/update/', views.MessageUpdateView.as_view(), name='message_update'),
    path('messages/<int:pk>/delete/', views.MessageDeleteView.as_view(), name='message_delete'),

    # Получатели
    path('recipients/', cache_page(60 * 15)(views.RecipientListView.as_view()), name='recipient_list'),
